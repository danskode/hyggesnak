...
const users = [
    { username: 'far', password: 'Familie1', email: 'bjorn@zappa.club', role: 'USER' },
    { username: 'mor', password: 'Familie1', email: 'steen@zappa.club', role: 'ADMIN' },
    { username: 'barn', password: 'Familie1', email: 'mulle@zappa.club', role: 'USER' }
];
